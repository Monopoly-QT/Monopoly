            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle{
                            Layout.preferredHeight: rocketCard.isOpen ? 200 : 0
                            Layout.fillWidth: true
                            color: "transparent"
                            ColumnLayout{
                                anchors.fill: parent
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            Layout.preferredHeight: diceCard.isOpen ? 200 : 0
                            Layout.fillWidth: true
                            color: "transparent"
                            ColumnLayout {
                                anchors.fill: parent
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            Layout.preferredHeight: removeCard.isOpen ? 200 : 0
                            Layout.fillWidth: true
                            color: "transparent"
                            ColumnLayout {
                                anchors.fill: parent
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            Layout.preferredHeight: roadBlockCard.isOpen ? 200 : 0
                            Layout.fillWidth: true
                            color: "transparent"
                            ColumnLayout {
                                anchors.fill: parent
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                Text {
                                    ...
                                    color: "white"
                                    transformOrigin: Item.Center
                                    rotation: eventCard.isOpen ? -90 : 0
                                    Behavior on rotation {
                                        NumberAnimation {
                                            duration: 200
                                            easing.type: Easing.InOutQuad
                                ...
                                MouseArea {
                                    anchors.fill: parent
                                    onPressed: {
                                        eventCard.isOpen = !eventCard.isOpen
                                    }
                                }
                            }
                        }
                        ...
                        Rectangle {
                            Layout.preferredHeight: eventCard.isOpen ? 200 : 0
                            Layout.fillWidth: true
                            color: "transparent"
                            ColumnLayout {
                                anchors.fill: parent
